...
# from ultralytics.nn.EMA_attention import EMA
# from ultralytics.nn.attention import SCSA
from ultralytics.nn.ELA import ELA
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [ch[f], *args]
        # elif m is EMA:                                 # 添加EMA通道数
        #     args = [ch[f], *args]
        elif m is ELA:  # 添加EMA通道数
            args = [ch[f], *args]
